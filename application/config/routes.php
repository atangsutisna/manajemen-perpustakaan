...
$route['buku/(:num)/delete'] = 'buku/delete/$1';
$route['buku/(:num)/edit'] = 'buku/edit/$1';

$route['anggota/(:num)/delete'] = 'anggota/delete/$1';
$route['anggota/(:num)/edit'] = 'anggota/edit/$1';

$route['user_group/(:num)/delete'] = 'user_group/delete/$1';
$route['user_group/(:num)/edit'] = 'user_group/edit/$1';
